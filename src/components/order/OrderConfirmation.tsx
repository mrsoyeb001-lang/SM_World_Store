...
// NOTE: CurrencyBangla is a tiny helper that formats numbers to ৳ and locale
...
export default function OrderConfirmation() {
  ...
  const handleShare = async () => {
    ...
    const shareData = {
      ...
      text: `আমি SM World BD থেকে একটি অর্ডার করেছি। অর্ডার আইডি: ${order.id.slice(0, 8)}, মোট মূল্য: ${CurrencyBangla(order.total_amount)}. বিস্তারিত দেখতে ভিজিট করুন।`
    } as any;
